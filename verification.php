<?php 
    ...
    if(isset($_POST['android_verify_btn'])){
        ...
        if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'] AND $envato_buyer->item->id=='9127749')
        {
        ...
        $envato_buyer= verify_envato_purchase_code(trim($_POST['envato_ios_purchase_code']));

        if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'] AND $envato_buyer->item->id=='21555205')
        {
